...
class PDFCV(FPDF):
    ...
    def generate_cv(self, name, email, phone_number, address, skills, work_experience, education, about_me):
        ...
        self.cell(0, 10, name,
                  new_x="MARGIN", new_y="NEXT", align="C")
        self.set_font("Arial", "B", 12)

        self.cell(0, 10, "Contact Information",
                  new_x="MARGIN", new_y="NEXT", align="L")
        self.set_font("Arial", "", 10)

        # self.cell(0, 5, "Name: {}".format(name), new_x="MARGIN", new_y="NEXT")
        self.cell(0, 5, "Email: {}".format(email),
                  new_x="MARGIN", new_y="NEXT")
        ...
        self.ln(10)
        self.set_font("Arial", "B", 12)
        self.cell(10, 10, "Skills", new_x="MARGIN", new_y="NEXT", align="R")
        self.set_font("Arial", "", 10)
        for skill in skills:
        ...
        for experience in work_experience:
            self.cell(0, 5, "{}: {}".format(
                experience['title'], experience['description']), new_x="MARGIN", new_y="NEXT")

        # Education
        self.ln(10)
        self.set_font("Arial", "B", 12)
        self.cell(0, 10, "Education", new_x="MARGIN", new_y="NEXT", align="L")
        self.set_font("Arial", "", 10)
        for education_item in education:
            self.cell(0, 5, "{}: {}".format(
                education_item['degree'], education_item['university']), new_x="MARGIN", new_y="NEXT")
...
def generate_cv_pdf():
    ...
    # Validate input
    if (not name or not email or not phone_number or not address or not skills or not work_experience or not education or
            not about_me):
